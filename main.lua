...
local menu_renderer = require("renderers.menu_renderer")
    ...
    if plugin_enabled then
        if teleporting then
            ...
            if current_world:get_name():find("Limbo") then
                ...
                if loading_start_time and (current_time - loading_start_time) < 25 then --was 4 add 25 secs
                    return
                end
                loading_start_time = nil
            end
            ...
            if local_player then
                ...
                if current_in_helltide then
                    ...
                    console.print("Not in Helltide zone. Attempting to teleport in 10 seconds.")
                    current_city_index = (current_city_index % #helltide_tps) + 1
                    -- Add a delay of 10 seconds
                    local delay_start = os.clock()
                    while os.clock() - delay_start < 10 do
...
on_render_menu(menu_renderer.render)